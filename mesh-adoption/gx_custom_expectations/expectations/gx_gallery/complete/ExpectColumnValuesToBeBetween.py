...
class ExpectColumnValuesToBeBetween(ColumnMapExpectation):
    ...
    def get_validation_dependencies(
        ...
        **kwargs: dict,
        ...
        print(f"row_count: {metric_kwargs}")
    ...
    def _validate(
        ...
        print(metrics)
        print(f"Unexpected: {get_metric_kwargs(metric_name=f'{self.map_metric}.{SummarizationMetricNameSuffixes.UNEXPECTED_VALUES.value}',configuration=self.configuration, runtime_configuration=runtime_configuration,)}")
        print(f"RowCount: {get_metric_kwargs(metric_name='table.row_count',configuration=self.configuration,runtime_configuration=runtime_configuration,)}")
