...
class ExpectQueriedTableRowCountToBe(QueryExpectation):
    ...
    #     query_result = list(metrics.get("query.table")[0].values())[0]
    #     value = configuration["kwargs"].get("value")
    #     total_count = query_result

    #     if isinstance(execution_engine, PandasExecutionEngine):
    #         total_count = len(execution_engine.get_batch_data("query.table"))

    #     elif isinstance(execution_engine, SparkDFExecutionEngine):
    #         total_count = execution_engine.get_batch_data("query.table").count()
    ...
    #         "success": success,
    #         "result": {
    #             "observed_value": query_result,  # Valore dopo il filtro
    #             "element_count": total_count,  # Numero totale di righe nella tabella
    #         },
    #     }
