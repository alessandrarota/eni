...
class ExpectTableRowCountToBeBetween(BatchExpectation):
    ...
    def _validate(
        ...
        result_obj = self._validate_metric_value_between(
        ...
        return_obj: Dict[str, Any] = {"success": result_obj["success"]}
        result = result_obj["result"]
        return_obj["result"] = {
            "element_count": result["observed_value"],
            "expectation_output_metric": result["observed_value"],
        }
