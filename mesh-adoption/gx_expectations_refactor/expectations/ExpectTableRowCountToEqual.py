...
class ExpectTableRowCountToEqual(BatchExpectation):
    ...
    def _validate(
        ...
        return_obj: Dict[str, Any] = {"success": actual_table_row_count == expected_table_row_count}
        return_obj["result"] = {
            "element_count": actual_table_row_count,
            "expectation_output_metric": actual_table_row_count,
        }
